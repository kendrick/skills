Title: Update job settings partially | Jobs API | REST API reference

URL Source: https://docs.databricks.com/api/workspace/jobs/update
...
Add, update, or remove specific settings of an existing job. Use the [_Reset_ endpoint](https://docs.databricks.com/api/workspace/jobs/reset) to overwrite all job settings.

API scopes (preview):[`jobs`](https://docs.databricks.com/api/workspace/api/scopes#jobs)

### Request body

[`fields_to_remove`](https://docs.databricks.com/api/workspace/jobs/update#fields_to_remove)Array of string
...
[`job_id`](https://docs.databricks.com/api/workspace/jobs/update#job_id)required int64

Example`11223344`

The canonical identifier of the job to update. This field is required.

[`new_settings`](https://docs.databricks.com/api/workspace/jobs/update#new_settings)object
...
[`budget_policy_id`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-budget_policy_id)uuid
...
[`continuous`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-continuous)object
...
[`deployment`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-deployment)object

Deployment information for jobs managed by external sources.

[`description`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-description)string
...
[`edit_mode`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-edit_mode)string
...
[`email_notifications`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-email_notifications)object
...
[`environments`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-environments)Array of object
...
[`format`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-format)string
...
[`git_source`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-git_source)object
...
[`health`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-health)object

An optional set of health rules that can be defined for this job.

[`job_clusters`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-job_clusters)Array of object
...
[`max_concurrent_runs`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-max_concurrent_runs)int32
...
[`name`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-name)string
...
[`notification_settings`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-notification_settings)object
...
[`parameters`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-parameters)Array of object

Job-level parameter definitions

[`performance_target`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-performance_target)string
...
[`queue`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-queue)object

The queue settings of the job.

[`run_as`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-run_as)object
...
[`schedule`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-schedule)object
...
[`tags`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-tags)object
...
[`tasks`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-tasks)Array of object
...
[`timeout_seconds`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-timeout_seconds)int32
...
[`trigger`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-trigger)object
...
[`webhook_notifications`](https://docs.databricks.com/api/workspace/jobs/update#new_settings-webhook_notifications)object
