Title: Delete a query | Queries API | REST API reference

URL Source: https://docs.databricks.com/api/workspace/queries/delete
...
[`id`](https://docs.databricks.com/api/workspace/queries/delete#id)required string
