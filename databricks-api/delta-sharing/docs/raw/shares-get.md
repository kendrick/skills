Title: Get a share | Shares API | REST API reference

URL Source: https://docs.databricks.com/api/workspace/shares/get
...
[`name`](https://docs.databricks.com/api/workspace/shares/get#name)required string

The name of the share.

### Query parameters

[`include_shared_data`](https://docs.databricks.com/api/workspace/shares/get#include_shared_data)boolean

Example`include_shared_data=true`
...
[`comment`](https://docs.databricks.com/api/workspace/shares/get#comment)string

User-provided free-form text description.

[`created_at`](https://docs.databricks.com/api/workspace/shares/get#created_at)int64

Time at which this share was created, in epoch milliseconds.

[`created_by`](https://docs.databricks.com/api/workspace/shares/get#created_by)string

Username of share creator.

[`name`](https://docs.databricks.com/api/workspace/shares/get#name)string

Name of the share.

[`objects`](https://docs.databricks.com/api/workspace/shares/get#objects)Array of object

A list of shared data objects within the share.

Array [

[`added_at`](https://docs.databricks.com/api/workspace/shares/get#objects-added_at)int64

The time when this data object is added to the share, in epoch milliseconds.

[`added_by`](https://docs.databricks.com/api/workspace/shares/get#objects-added_by)string

Username of the sharer.

[`cdf_enabled`](https://docs.databricks.com/api/workspace/shares/get#objects-cdf_enabled)boolean

Whether to enable cdf or indicate if cdf is enabled on the shared object.

[`comment`](https://docs.databricks.com/api/workspace/shares/get#objects-comment)string

A user-provided comment when adding the data object to the share.

[`content`](https://docs.databricks.com/api/workspace/shares/get#objects-content)string
...
[`data_object_type`](https://docs.databricks.com/api/workspace/shares/get#objects-data_object_type)string
...
[`history_data_sharing_status`](https://docs.databricks.com/api/workspace/shares/get#objects-history_data_sharing_status)string

Enum: `DISABLED | ENABLED`

Whether to enable or disable sharing of data history. If not specified, the default is DISABLED.

[`name`](https://docs.databricks.com/api/workspace/shares/get#objects-name)string
...
[`partitions`](https://docs.databricks.com/api/workspace/shares/get#objects-partitions)Array of object

Array of partitions for the shared data.

[`shared_as`](https://docs.databricks.com/api/workspace/shares/get#objects-shared_as)string
...
[`start_version`](https://docs.databricks.com/api/workspace/shares/get#objects-start_version)int64
...
[`status`](https://docs.databricks.com/api/workspace/shares/get#objects-status)string

Enum: `ACTIVE | PERMISSION_DENIED`

One of: ACTIVE, PERMISSION_DENIED.

[`string_shared_as`](https://docs.databricks.com/api/workspace/shares/get#objects-string_shared_as)string
...
[`owner`](https://docs.databricks.com/api/workspace/shares/get#owner)string

Username of current owner of share.

[`storage_location`](https://docs.databricks.com/api/workspace/shares/get#storage_location)string

Storage Location URL (full path) for the share.

[`storage_root`](https://docs.databricks.com/api/workspace/shares/get#storage_root)string

Storage root URL for the share.

[`updated_at`](https://docs.databricks.com/api/workspace/shares/get#updated_at)int64

Time at which this share was updated, in epoch milliseconds.

[`updated_by`](https://docs.databricks.com/api/workspace/shares/get#updated_by)string
