Title: Create a share | Shares API | REST API reference

URL Source: https://docs.databricks.com/api/workspace/shares/create
...
[`comment`](https://docs.databricks.com/api/workspace/shares/create#comment)string

User-provided free-form text description.

[`name`](https://docs.databricks.com/api/workspace/shares/create#name)required string

Name of the share.

[`storage_root`](https://docs.databricks.com/api/workspace/shares/create#storage_root)string
...
[`created_at`](https://docs.databricks.com/api/workspace/shares/create#created_at)int64

Time at which this share was created, in epoch milliseconds.

[`created_by`](https://docs.databricks.com/api/workspace/shares/create#created_by)string

Username of share creator.

[`name`](https://docs.databricks.com/api/workspace/shares/create#name)string

Name of the share.

[`objects`](https://docs.databricks.com/api/workspace/shares/create#objects)Array of object

A list of shared data objects within the share.

Array [

[`added_at`](https://docs.databricks.com/api/workspace/shares/create#objects-added_at)int64

The time when this data object is added to the share, in epoch milliseconds.

[`added_by`](https://docs.databricks.com/api/workspace/shares/create#objects-added_by)string

Username of the sharer.

[`cdf_enabled`](https://docs.databricks.com/api/workspace/shares/create#objects-cdf_enabled)boolean

Whether to enable cdf or indicate if cdf is enabled on the shared object.

[`comment`](https://docs.databricks.com/api/workspace/shares/create#objects-comment)string

A user-provided comment when adding the data object to the share.

[`content`](https://docs.databricks.com/api/workspace/shares/create#objects-content)string
...
[`data_object_type`](https://docs.databricks.com/api/workspace/shares/create#objects-data_object_type)string
...
[`history_data_sharing_status`](https://docs.databricks.com/api/workspace/shares/create#objects-history_data_sharing_status)string

Enum: `DISABLED | ENABLED`

Whether to enable or disable sharing of data history. If not specified, the default is DISABLED.

[`name`](https://docs.databricks.com/api/workspace/shares/create#objects-name)string
...
[`partitions`](https://docs.databricks.com/api/workspace/shares/create#objects-partitions)Array of object

Array of partitions for the shared data.

[`shared_as`](https://docs.databricks.com/api/workspace/shares/create#objects-shared_as)string
...
[`start_version`](https://docs.databricks.com/api/workspace/shares/create#objects-start_version)int64
...
[`status`](https://docs.databricks.com/api/workspace/shares/create#objects-status)string

Enum: `ACTIVE | PERMISSION_DENIED`

One of: ACTIVE, PERMISSION_DENIED.

[`string_shared_as`](https://docs.databricks.com/api/workspace/shares/create#objects-string_shared_as)string
...
[`owner`](https://docs.databricks.com/api/workspace/shares/create#owner)string

Username of current owner of share.

[`storage_location`](https://docs.databricks.com/api/workspace/shares/create#storage_location)string
...
[`updated_at`](https://docs.databricks.com/api/workspace/shares/create#updated_at)int64

Time at which this share was updated, in epoch milliseconds.

[`updated_by`](https://docs.databricks.com/api/workspace/shares/create#updated_by)string
