Title: Enforce job policy compliance | Policy compliance for jobs API | REST API reference

URL Source: https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance
...
[`job_id`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#job_id)required int64

The ID of the job you want to enforce policy compliance on.

[`validate_only`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#validate_only)boolean
...
[`has_changes`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#has_changes)boolean

Whether any changes have been made to the job cluster settings for the job to become compliant with its policies.

[`job_cluster_changes`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#job_cluster_changes)Array of object
...
[`field`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#job_cluster_changes-field)string

Example`"job_clusters[job_cluster_key].new_cluster.spark_version"`

The field where this change would be made, prepended with the job cluster key.

[`new_value`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#job_cluster_changes-new_value)string
...
[`previous_value`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#job_cluster_changes-previous_value)string
...
[`settings`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings)object
...
[`budget_policy_id`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-budget_policy_id)uuid
...
[`continuous`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-continuous)object
...
[`deployment`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-deployment)object

Deployment information for jobs managed by external sources.

[`description`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-description)string
...
[`edit_mode`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-edit_mode)string
...
[`email_notifications`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-email_notifications)object
...
[`environments`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-environments)Array of object
...
[`format`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-format)string
...
[`git_source`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-git_source)object
...
[`health`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-health)object

An optional set of health rules that can be defined for this job.

[`job_clusters`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-job_clusters)Array of object
...
[`max_concurrent_runs`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-max_concurrent_runs)int32
...
[`name`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-name)string
...
[`notification_settings`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-notification_settings)object
...
[`parameters`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-parameters)Array of object

Job-level parameter definitions

[`performance_target`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-performance_target)string
...
[`queue`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-queue)object

The queue settings of the job.

[`run_as`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-run_as)object
...
[`schedule`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-schedule)object
...
[`tags`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-tags)object
...
[`tasks`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-tasks)Array of object
...
[`timeout_seconds`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-timeout_seconds)int32
...
[`trigger`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-trigger)object
...
[`webhook_notifications`](https://docs.databricks.com/api/workspace/policycomplianceforjobs/enforcecompliance#settings-webhook_notifications)object
...
"field":"job_clusters[job_cluster_key].new_ cluster.spark_version",
