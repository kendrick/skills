Title: Update a warehouse | SQL Warehouses API | REST API reference

URL Source: https://docs.databricks.com/api/workspace/warehouses/edit
...
[`id`](https://docs.databricks.com/api/workspace/warehouses/edit#id)required string
...
[`auto_stop_mins`](https://docs.databricks.com/api/workspace/warehouses/edit#auto_stop_mins)int32
...
[`channel`](https://docs.databricks.com/api/workspace/warehouses/edit#channel)object

Channel Details

[`dbsql_version`](https://docs.databricks.com/api/workspace/warehouses/edit#channel-dbsql_version)string

[`name`](https://docs.databricks.com/api/workspace/warehouses/edit#channel-name)string

Enum: `CHANNEL_NAME_PREVIEW | CHANNEL_NAME_CURRENT | CHANNEL_NAME_PREVIOUS | CHANNEL_NAME_CUSTOM`

[`cluster_size`](https://docs.databricks.com/api/workspace/warehouses/edit#cluster_size)string
...
[`creator_name`](https://docs.databricks.com/api/workspace/warehouses/edit#creator_name)string

warehouse creator name

[`enable_photon`](https://docs.databricks.com/api/workspace/warehouses/edit#enable_photon)boolean

Configures whether the warehouse should use Photon optimized clusters.

Defaults to true.

[`enable_serverless_compute`](https://docs.databricks.com/api/workspace/warehouses/edit#enable_serverless_compute)boolean

Configures whether the warehouse should use serverless compute

[`instance_profile_arn`](https://docs.databricks.com/api/workspace/warehouses/edit#instance_profile_arn)string

Deprecated

Deprecated. Instance profile used to pass IAM role to the cluster

[`max_num_clusters`](https://docs.databricks.com/api/workspace/warehouses/edit#max_num_clusters)int32
...
[`min_num_clusters`](https://docs.databricks.com/api/workspace/warehouses/edit#min_num_clusters)int32
...
[`name`](https://docs.databricks.com/api/workspace/warehouses/edit#name)string
...
[`spot_instance_policy`](https://docs.databricks.com/api/workspace/warehouses/edit#spot_instance_policy)string
...
[`tags`](https://docs.databricks.com/api/workspace/warehouses/edit#tags)object
...
[`custom_tags`](https://docs.databricks.com/api/workspace/warehouses/edit#tags-custom_tags)Array of object

[`warehouse_type`](https://docs.databricks.com/api/workspace/warehouses/edit#warehouse_type)string
