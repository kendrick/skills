...
>
> **Division of labor:** Durable structured records (crystallized decisions, stable facts, standing rules) live in [`_memory/`](_memory/) and are referenced by id, not duplicated here. Raw notes live in [`notes/`](notes/). Cross-client pattern candidates live in [`patterns-journal/`](patterns-journal/).
>
> **Scope:** Compact and focused with one-line rationale per decision. For deeper rationale, see the working file the decision affects.
>
> **Last updated:** {{date}}
...
**Just completed:** <!-- what shipped or settled in the last session -->
...
- **<!-- decision -->** _(<!-- one-line rationale; cite source -->)_
...
- <!-- hypothesis — _(evidence so far)_ -->
