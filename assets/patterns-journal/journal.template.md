...
Conventions, tag vocabulary, weekly-review ritual, and promotion flow live in [CLAUDE.md](CLAUDE.md).
...
- Reusable pattern candidate. Don't yet generalize — that's a separate operation. #reusable-candidate
